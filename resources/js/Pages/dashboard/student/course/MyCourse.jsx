                    ...
                    {enrollments.map((enrollment) => {
                        ...
                        try {
                            ...
                            if (savedProgress) {
                                ...
                                // Count final quiz
                                if (progressData.finalQuiz) {
                                    totalItems++;
                                    if (progressData.finalQuiz.done)
                                        completedItems++;
                                }
                        ...
                        const statusLabel =
                            progress >= 100 ? "Completed" : "On Progress";
                        const statusStyle =
                            progress >= 100
